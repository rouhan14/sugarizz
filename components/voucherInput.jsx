      ...
      {!appliedVoucher ? (
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 text-sm bg-white/10 border border-white/20 rounded-md text-white placeholder-gray-400 focus:outline-none focus:border-white/40 disabled:opacity-50"
          />
          <button
            type="button"
            onClick={handleApplyVoucher}
            disabled={disabled || isValidating || !voucherCode.trim()}
            className="px-4 py-2 text-sm bg-blue-500/70 hover:bg-blue-500/80 text-white rounded-md border border-white/20 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >

...
export default function CookieHero({
    ...
    const isOutOfStock = title === "Choco Walnut Cookie" || title === "Peanut Butter Cookie" || title === "HazelNut Chocolate Cookie" || title === "Cookie & Cream Cookie" || title === "Red Velvet Cookie";

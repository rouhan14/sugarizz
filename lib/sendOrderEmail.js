        ...
        <div style="padding: 30px;">
          <div style="background-color: #f3f4f6; border-left: 4px solid #3b82f6; padding: 20px; margin-bottom: 25px; border-radius: 0 8px 8px 0;">
            ...
            <div style="display: grid; gap: 8px;">
              ...
              ${orderTime ? `<div><strong style="color: #374151;">Order Time:</strong> <span style="color: #1f2937;">${orderTime}</span></div>` : ''}
            </div>
          </div>
          ...
          <div style="background-color: #ecfdf5; border-left: 4px solid #10b981; padding: 20px; margin-bottom: 25px; border-radius: 0 8px 8px 0;">
            ...
            ${deliveryZone ? `
            <div style="margin-bottom: 15px;">
              <h3 style="margin: 0 0 8px 0; color: #374151; font-size: 16px; font-weight: 600;">Delivery Zone:</h3>
              <div style="background-color: #ffffff; padding: 12px; border-radius: 6px; border: 1px solid #d1d5db;">
                <p style="margin: 0; color: #1f2937;">${deliveryZone}</p>
              </div>
            </div>
            ` : ''}
            ...
            ${distanceFromStore ? `
            <div style="margin-bottom: 15px;">
              <h3 style="margin: 0 0 8px 0; color: #374151; font-size: 16px; font-weight: 600;">Distance from Store:</h3>
              <div style="background-color: #ffffff; padding: 12px; border-radius: 6px; border: 1px solid #d1d5db;">
                <p style="margin: 0; color: #1f2937;">${distanceFromStore} km</p>
              </div>
            </div>
            ` : ''}
            ...
            <div style="margin-bottom: 15px;">
              ...
              <div style="background-color: #ffffff; padding: 12px; border-radius: 6px; border: 1px solid #d1d5db;">
                <p style="margin: 0; color: #1f2937;">${paymentMethod}</p>
              </div>
            </div>
            ` : ''}
            ...
            <div>
              <h3 style="margin: 0 0 8px 0; color: #374151; font-size: 16px; font-weight: 600;">Estimated Delivery Time:</h3>
              <div style="background-color: #ffffff; padding: 12px; border-radius: 6px; border: 1px solid #d1d5db;">
                <p style="margin: 0; color: #1f2937;">${eta || estimatedDeliveryTime}</p>
              </div>
            </div>
            ` : ''}
          </div>
          ...
          <div style="background-color: #f0f9ff; border-left: 4px solid #0ea5e9; padding: 20px; margin-bottom: 25px; border-radius: 0 8px 8px 0;">
            ...
            <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #d1d5db;">
              ...
              ${paymentDiscount ? `
              <div style="display: flex; justify-content: space-between; margin-bottom: 8px; padding-bottom: 8px;">
                <span style="color: #059669; font-weight: 500;">Payment Method Discount:</span>
                <span style="color: #059669; font-weight: 600;">-Rs. ${paymentDiscount}</span>
              </div>
              ` : ''}
              
              ${appliedVoucher ? `
              <div style="display: flex; justify-content: space-between; margin-bottom: 8px; padding-bottom: 8px; background-color: #dcfce7; padding: 8px; border-radius: 4px; margin: 8px -8px;">
                <span style="color: #059669; font-weight: 500;">Voucher Applied (${appliedVoucher.code}):</span>
                <span style="color: #059669; font-weight: 600;">-Rs. ${appliedVoucher.discountAmount}</span>
              </div>
              ` : ''}
              
              ${voucherDiscount && voucherDiscount > 0 ? `
              <div style="display: flex; justify-content: space-between; margin-bottom: 8px; padding-bottom: 8px;">
                <span style="color: #059669; font-weight: 500;">Total Voucher Discount:</span>
                <span style="color: #059669; font-weight: 600;">-Rs. ${voucherDiscount}</span>
              </div>
              ` : ''}
              
              ${finalPrice !== subtotal ? `
              <div style="display: flex; justify-content: space-between; margin-bottom: 8px; padding-bottom: 8px;">
                <span style="color: #374151; font-weight: 500;">Price before Discounts:</span>
                <span style="color: #1f2937; font-weight: 600;">Rs. ${finalPrice}</span>
              </div>
              ` : ''}

              ${finalPrice !== subtotal ? `
              <div style="display: flex; justify-content: space-between; margin-bottom: 8px; padding-bottom: 8px;">
                <span style="color: #374151; font-weight: 500;">Price after Discounts:</span>
                <span style="color: #1f2937; font-weight: 600;">Rs. ${finalPriceWithVoucher}</span>
              </div>
              ` : ''}
              ...
              <div style="display: flex; justify-content: space-between;">
                <span style="color: #1f2937; font-weight: 700; font-size: 18px;">Final Total:</span>
              ...
              <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #e5e7eb;">
                <div style="display: flex; justify-content: space-between; font-size: 14px; color: #6b7280;">
                  ...
                  <span style="color: #059669; font-weight: 600;">Rs. ${(paymentDiscount || 0) + (voucherDiscount || 0)}</span>
                </div>
              </div>
              ` : ''}
            </div>
